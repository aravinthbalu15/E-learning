          ...
          <div className="flex gap-5 items-center">
            ...
            <div>
              ...
              <p className="text-white/90 mt-2 max-w-xl">
                Master the fundamentals of relationship management and sales
                pipeline automation using the Odoo framework.
              </p>
            </div>
          </div>

          {/* RIGHT PROGRESS CARD */}
          <div className="bg-white/20 backdrop-blur-md rounded-xl p-5 w-full lg:w-80">
            <p className="text-sm mb-2">30% Completed</p>

            <div className="w-full bg-white/30 h-2 rounded-full mb-4">
              <div className="bg-green-400 h-2 rounded-full w-[30%]"></div>
            </div>
